    ...
    match v
    {
        ...
        Voxel::Stone0 =>
        {
            VoxelMaterial {
                ...
                subsurface_color:          glm::Vec4::new(0.0, 0.0, 0.0, 0.0),
                diffuse_subsurface_weight: 0.0,
                specular_color:            glm::Vec4::new(0.3, 0.3, 0.3, 1.0),
                specular:                  0.2,
                roughness:                 0.8,
                metallic:                  0.0,
                emissive_color_and_power:  glm::Vec4::new(0.0, 0.0, 0.0, 0.0),
        ...
        Voxel::Stone1 =>
        {
            VoxelMaterial {
                ...
                subsurface_color:          glm::Vec4::new(0.0, 0.0, 0.0, 0.0),
                diffuse_subsurface_weight: 0.0,
                specular_color:            glm::Vec4::new(0.52, 0.52, 0.52, 1.0),
                specular:                  0.22,
                roughness:                 0.78,
                metallic:                  0.0,
                emissive_color_and_power:  glm::Vec4::new(0.0, 0.0, 0.0, 0.0),
        ...
        Voxel::Stone14 =>
        {
            VoxelMaterial {
                ...
                subsurface_color:          glm::Vec4::new(0.0, 0.0, 0.0, 0.0),
                diffuse_subsurface_weight: 0.0,
                specular_color:            glm::Vec4::new(0.45, 0.45, 0.45, 1.0),
                specular:                  0.25,
                roughness:                 0.85,
                metallic:                  0.0,
                emissive_color_and_power:  glm::Vec4::new(0.0, 0.0, 0.0, 0.0),
