...
//                 log::warn!("failed to get system locale, falling back to
...
//         // let mut font_system =
// glyphon::FontSystem::new_with_fonts([source]);         // let mut font_system
// = glyphon::FontSystem::new();         let cache = glyphon::SwashCache::new();
...
//     {
//         let mut buffer =
// glyphon::Buffer::new_empty(glyphon::Metrics::new(16.0, 16.0));
...
//         buffer.set_size(font_system, physical_width as f32, physical_height
// as f32);         buffer.shape_until_scroll(font_system, true);
...
//         const UPDATE_SPACING_TIME: std::time::Duration =
...
//     fn record<'s>(&'s self, render_pass: &mut gfx::GenericPass<'s>, maybe_id:
// Option<gfx::DrawId>)     {
